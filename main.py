...
def xml_parser(tree):
    ...
    for job in jobs:
        ...
        companydescription_text=companydescription.strip() if category else 'Null'
        ...
        #print(df_xml)
    df_xml.to_csv('myxml_2.csv',mode='a',quoting=csv.QUOTE_ALL,encoding='utf-8', index=False, header=True)
